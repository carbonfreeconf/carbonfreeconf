...
urlpatterns = [
    url(r'^qaindex/$', views.QuestionIndexView.as_view(), name='qa_index'),

    url(r'^qaindex/(?P<idconf>\d+)/$', views.QuestionIndexView.as_view(), name='qa_index'),
    ...
    url(r'^new-question/(?P<idconf>\d+)/$', views.CreateQuestionView.as_view(),
        name='qa_create_question'),
    ...
    url(r'^delete-question/(?P<question_id>\d+)/$',
        views.DeleteQuestionView.as_view(),
        name='qa_delete_question'),

    url(r'^delete-question/(?P<question_id>\d+)/(?P<idconf>\d+)/$',
        views.DeleteQuestionView.as_view(),
        name='qa_delete_question'),
    ...
    url(r'^search/(?P<idconf>\d+)/$', views.QuestionsSearchView.as_view(), name='qa_search'),

    url(r'^tag/(?P<tag>[-\w]+)/$',
        views.QuestionsByTagView.as_view(), name='qa_tag'),
    
    url(r'^tag/(?P<tag>[-\w]+)/(?P<idconf>\d+)/$',
        views.QuestionsByTagView.as_view(), name='qa_tag'),
